...
const Card = (props) => {
  ...
  const containerStyles = cn([
    card1["c-cards-view__container"],
    card2["c-cards-view__container"],
    card4["c-cards-view__container"],
    card5["c-cards-view__container"],
  ]);
  const mediaStyles = cn([
    card1["c-cards-view__media"],
    card2["c-cards-view__media"],
    card4["c-cards-view__media"],
    card5["c-cards-view__media"],
  ]);
  const buttonStyles = cn([
    card1["c-cards-view__buttons"],
    card2["c-cards-view__buttons"],
    card4["c-cards-view__buttons"],
    card5["c-cards-view__buttons"],
  ]);
  const categoryStyles = cn([
    card1["c-cards-view__category"],
    card2["c-cards-view__category"],
    card4["c-cards-view__category"],
    card5["c-cards-view__category"],
  ]);
  const headingStyles = cn([
    card1["c-cards-view__heading"],
    card2["c-cards-view__heading"],
    card4["c-cards-view__heading"],
    card5["c-cards-view__heading"],
  ]);
  const descriptionStyles = cn([
    card1["c-cards-view__description"],
    card2["c-cards-view__description"],
    card4["c-cards-view__description"],
    card5["c-cards-view__description"],
  ]);
  const viewButtonStyles = cn([
    card1["c-cards-view__view-buttons"],
    card2["c-cards-view__view-buttons"],
    card4["c-cards-view__view-buttons"],
    card5["c-cards-view__view-buttons"],
  ]);
  // const authorStyles = cn([
  //   card1["c-cards-view__author"],
  //   card2["c-cards-view__author"],
  //   card4["c-cards-view__author"],
  //   card5["c-cards-view__author"],
  // ]);
  const timeStyles = cn([
    card1["c-cards-view__time"],
    card2["c-cards-view__time"],
    card4["c-cards-view__time"],
    card5["c-cards-view__time"],
  ]);
  ...
  if (
    typeof props.galleryButtons !== "undefined" &&
    props.galleryButtons === false
  ) {
  ...
  if (
    typeof props.viewAllButton !== "undefined" &&
    props.viewAllButton === false
  ) {
    viewAllButton = false;
  }

  // Admin lets a user pin and swap cards
  let admin = false;
  ...
  if (typeof image.path !== "undefined" && image.path !== null && image.path) {
    const url = image.path.replace(
      "/upload/",
      "/upload/c_fill,dpr_auto,f_auto,fl_lossy,g_faces:auto,q_auto,w_500,h_340/"
    );
  ...
  return (
    ...
    <div
      className={cn(styles)}
      onClick={() => {
        !galleryButtons && props.cardHandler(count, panel);
      }}
    >
      <div
        ...
        <article className={viewStyles}>
          ...
          <div className={containerStyles}>
            ...
            <h2 className={headingStyles}>
              <Dotdotdot clamp={2}>{props.data.title} </Dotdotdot>
            </h2>
            ...
            {galleryButtons && (
              <div className={viewButtonStyles}>
                ...
                {viewAllButton && (
                  <Viewall
                    onClick={() =>
                      props.linkHandler("/single-gallery/" + props.data.id)
                    }
                  >
                    View All
                  </Viewall>
            ...
            {props.data.createdDate && (
              <div className={timeStyles}>POSTED {props.data.createdDate}</div>
            )}
