...
class App extends Component {
  ...
  render() {
    ...
    const favourites = (
      <Modal
        closeHandler={this.closeFavourites}
        children={() => (
          <Favourites
    ...
    return (
      <div style={{ marginBottom: "60px" }} data-env={this.props.env}>
        ...
        >
          ...
          <Route
            path={window.basePath + "/single-gallery/:id"}
            render={() => (
              <Home
                linkHandler={this.linkHandler}
                checkPhotoStatus={this.photoStatusHandler}
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    fixNetwork: (photo, networkId) =>
      dispatch(actionCreators.fixNetworkId(photo, networkId)),
  };
};
